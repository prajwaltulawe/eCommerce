              ...
              <div class="col-md-5 no-padding">                
                <div class="aa-promo-left">
                  <div class="aa-promo-banner">                    
                    <img src="{{asset('frontAssets/img/promo-banner-1.jpg')}}" alt="img">                    
              ...
              <div class="col-md-7 no-padding">
                <div class="aa-promo-right">
                  <div class="aa-single-promo-right">
                    <div class="aa-promo-banner">                      
                      <img src="{{asset('frontAssets/img/promo-banner-3.jpg')}}" alt="img">                      
                      <div class="aa-prom-content">
                  ...
                  <div class="aa-single-promo-right">
                    <div class="aa-promo-banner">                      
                      <img src="{{asset('frontAssets/img/promo-banner-2.jpg')}}" alt="img">                      
                      <div class="aa-prom-content">
                        <span>Sale Off</span>
                  ...
                  <div class="aa-single-promo-right">
                    <div class="aa-promo-banner">                      
                      <img src="{{asset('frontAssets/img/promo-banner-4.jpg')}}" alt="img">                      
                      <div class="aa-prom-content">
                  ...
                  <div class="aa-single-promo-right">
                    <div class="aa-promo-banner">                      
                      <img src="{{asset('frontAssets/img/promo-banner-5.jpg')}}" alt="img">                      
                      <div class="aa-prom-content">
                        <span>25% Off</span>
                  ...
                  <div class="tab-content">
                    ...
                    <div class="tab-pane fade" id="women">
                      <ul class="aa-product-catg">
                        ...
                        <li>
                          <figure>
                            <a class="aa-product-img" href="#"><img src="{{asset('frontAssets/img/women/girl-1.png')}}" alt="polo shirt img"></a>
                            <a class="aa-add-card-btn"href="#"><span class="fa fa-shopping-cart"></span>Add To Cart</a>
                            <figcaption>
                    ...
                    <div class="tab-pane fade" id="sports">
                      <ul class="aa-product-catg">
                        ...
                        <li>
                          <figure>
                            <a class="aa-product-img" href="#"><img src="{{asset('frontAssets/img/sports/sport-1.png')}}" alt="polo shirt img"></a>
                            <a class="aa-add-card-btn"href="#"><span class="fa fa-shopping-cart"></span>Add To Cart</a>
                            <figcaption>
                              <h4 class="aa-product-title"><a href="#">This is Title</a></h4>
                              <span class="aa-product-price">$45.50</span><span class="aa-product-price"><del>$65.50</del></span>
                    ...
                    <div class="tab-pane fade" id="electronics">
                       <ul class="aa-product-catg">
                        ...
                        <li>
                          <figure>
                            <a class="aa-product-img" href="#"><img src="{{asset('frontAssets/img/electronics/electronic-1.png')}}" alt="polo shirt img"></a>
                            <a class="aa-add-card-btn"href="#"><span class="fa fa-shopping-cart"></span>Add To Cart</a>
                            <figcaption>
                              <h4 class="aa-product-title"><a href="#">This is Title</a></h4>
                              <span class="aa-product-price">$45.50</span><span class="aa-product-price"><del>$65.50</del></span>
