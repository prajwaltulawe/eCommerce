    ...
    <div class="card-body">
        <form action="{{route('product.manage')}}" method="post" novalidate="novalidate" enctype="multipart/form-data">
            ...
            <div class="qualityAttributes mt-2" id="pAttArr{{$pAttArr['id']}}">
                <div class="form-group" style="display: flex;justify-content: space-between;">
                    <input type="hidden" name="pAttId[]" value="{{$pAttArr['id']}}">
                    <div class="form-group">
                ...
                <div class="form-group" style="display: flex;justify-content: space-between;">
                    ...
                    <div class="form-group col-4">
                        ...
                        <input id="attrImage" name="attrImage[]" type="file" class="form-control col-12" aria-required="true" aria-invalid="false" value="{{$pAttArr['attrImage']}}">
                        @error('image')
                            {{$message}}
                        @enderror
                    </div>
            ...
            @endforeach
            <div class="qualityAttributes mt-2" id="pAttArr">
                <div class="form-group" style="display: flex;justify-content: space-between;">
                    <div class="form-group">
                        <label for="sku" class="control-label mb-1">SKU</label>
                        <input id="sku" name="sku[]" type="text" class="form-control col-10" aria-required="true" aria-invalid="false" >
                    </div>
                    ...
                    <div class="form-group">
                        <label for="qty" class="control-label mb-1">Qty</label>
                        <input id="qty" name="qty[]" type="text" class="form-control col-10" aria-required="true" aria-invalid="false">
                    </div>
                </div>
                <div class="form-group" style="display: flex;justify-content: space-between;">
                    <div class="form-group col-4" style="padding: 0;">
...
<script>
    var loopCount = document.getElementsByClassName('qualityAttributes').length;
    function addMore(){
        loopCount++;
        var attriHtml = document.getElementById('pAttArr');
        attriHtml.id = "pAttArr"+loopCount; 
